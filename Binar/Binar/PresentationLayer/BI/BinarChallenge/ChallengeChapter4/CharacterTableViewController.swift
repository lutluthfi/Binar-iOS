...
class CharacterViewController: UITableViewController {
    ...
    var characterArray: [GameCharacter] = []
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        characterImage.loadImage(resource: characterArray[row].imageURLString)
...
extension CharacterViewController {
    ...
    func createGameCharacter(firstName: String, lastName: String, description: String, specialAbility: SpecialAbility, imageURLString: String, characterColor: CharacterColor) {
        
        let character = GameCharacter(firstName: firstName, lastName: lastName, description: description, specialAbility: specialAbility, imageURLString: imageURLString, characterColor: characterColor)
