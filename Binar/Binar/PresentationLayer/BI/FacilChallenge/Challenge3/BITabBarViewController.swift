...
//        tableView.register(UITableViewCell.self, forCellReuseIdentifier: "cell")
        ...
        let shareStory = UIAction(title: "Share Story", image: UIImage(systemName: "square.and.arrow.up"), identifier: nil) { [self] _ in
            BINewsSharer.share(in: self, newsHeadline: newsLabel.text!, newsImageUrlString: "https://akcdn.detik.net.id/community/media/visual/2022/03/29/cristiano-ronaldo-2_169.jpeg?w=700&q=90")
        }
